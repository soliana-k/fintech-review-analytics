...
The project transforms raw customer feedback into structured sentiment and thematic insights that can help product teams identify usability issues, app stability problems, and customer pain points.
...
- Saves raw data to the local storage layer
